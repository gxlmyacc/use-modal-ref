...
declare function usePopoverRef<T extends Record<string, any>, U = any>(ref: React.Ref<any>, defaultData?: Partial<T> | (() => Partial<T>), options?: ModalRefOption<'popover', T, U>, deps?: React.DependencyList): {
